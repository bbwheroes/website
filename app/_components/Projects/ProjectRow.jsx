...
export default function ProjectRow({ project }) {
  ...
  return (
    <li className="flex w-full items-center justify-between rounded-md bg-gray-800 p-4 text-white shadow-sm shadow-gray-700">
      ...
      <a href={`https://github.com/bbwheroes/${fullProjectName}`} className="flex aspect-square h-10 items-center justify-center rounded-full bg-gray-700 text-gray-300 duration-100 hover:bg-gray-600">
